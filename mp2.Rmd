...
ggplot(data = ca_districts, aes(x = district, y = total_amount, fill = transaction_type.y)) +
  ...
  scale_fill_discrete(name = "Money Spent in CA", labels = c('money spent against the loser', 'money spent for the winner')) +
  ylab("Money Spent by Percent") +
  xlab("Districts in CA")
```
#Goal
This first graph is how 
...
## Summary
For any state, this graphic takes information about the 2012 house elections and maps, per district, the percent of money, spent by any committee, in support of the candidate who won against the percent of money, spent by any committee, in opposition of the candidate who lost.
